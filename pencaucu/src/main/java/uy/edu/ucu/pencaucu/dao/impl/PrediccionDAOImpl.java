...
public class PrediccionDAOImpl implements IPrediccionDAO {
	...
	public List<PrediccionDTO> getAllPrediccion() {
		// Buscar todas las predicciones en la base de datos utilizando Dozer para
		// mapear las entidades a DTOs y devolverlas
	...
	public List<PrediccionDTO> getAllPrediccionByFilter(PrediccionDTO prediccionDTO) {
		Example<Prediccion> prediccionExample = Example
				.of(DozerUtil.GetINSTANCE().getMapper().map(prediccionDTO, Prediccion.class));
